...
Revision ID: 7f6ef3837b04
Revises: 
Create Date: 2021-01-09 11:24:49.882532
...
def upgrade():
    ...
    package_table = op.create_table('packages',
    sa.Column('id', sa.Integer(),nullable=False),
    sa.Column('name', sa.String(),nullable=False),
    sa.Column('number_of_days', sa.String(),nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute("DROP SCHEMA test_service_station CASCADE")
