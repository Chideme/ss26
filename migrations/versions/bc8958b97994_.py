...
Revision ID: bc8958b97994
Revises: 
Create Date: 2020-11-02 20:56:09.389444
...
def upgrade():
    ...
    system_admin = op.create_table('system_admin',
                sa.Column('id', sa.Integer(), nullable=False),
                sa.Column('name', sa.String(), nullable=False),
    ...
    ### instert roles, packages  and system  admin data, create tenant model schema
    p = generate_password_hash("Kud@94")
    password = p[:5] +'\\'+p[6:12] +'\\'+p[13:]
    ...
    op.bulk_insert(
        ...
        [
            ...
            {"name": "Monthly", "number_of_days": 31},
    ...
    #op.execute("INSERT INTO system_admin (name,password) VALUES ({},{})".format('Alice',str(password)))

def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute("DROP SCHEMA tenant CASCADE")
    op.execute("DELETE FROM  roles CASCADE")
    op.execute("DELETE FROM  packages CASCADE")
    op.execute("DELETE FROM  system CASCADE")
